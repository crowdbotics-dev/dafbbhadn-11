"""
Django settings for dafbbhadn_11 project.
...
ROOT_URLCONF = 'dafbbhadn_11.urls'
...
WSGI_APPLICATION = 'dafbbhadn_11.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dafbbhadn_11 API",
    "DESCRIPTION": "API documentation for dafbbhadn_11 App",
    "VERSION": "v1",
}
